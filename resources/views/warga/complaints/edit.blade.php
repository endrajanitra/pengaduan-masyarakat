        ...
        <form method="POST" action="{{ route('warga.complaints.update', $complaint) }}" class="space-y-6">
            ...
            <div>
                ...
                <select name="category_id" required
                    class="w-full px-3.5 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 {{ $errors->has('category_id') ? 'border-red-300' : 'border-gray-300' }}">
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title', $complaint->title) }}" required
                    class="w-full px-3.5 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 {{ $errors->has('title') ? 'border-red-300' : 'border-gray-300' }}">
            ...
            <div>
                ...
                <input type="text" name="location" value="{{ old('location', $complaint->location) }}" required
                    class="w-full px-3.5 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 {{ $errors->has('location') ? 'border-red-300' : 'border-gray-300' }}">
            ...
            <div>
                ...
                <textarea name="description" rows="5" required
                    class="w-full px-3.5 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 {{ $errors->has('description') ? 'border-red-300' : 'border-gray-300' }}">{{ old('description', $complaint->description) }}</textarea>
